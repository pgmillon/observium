...
foreach (dbFetchRows("SELECT * FROM `ospf_instances` WHERE `device_id` = ?", array($device['device_id'])) as $instance)
{
  ...
  echo('<thead><tr><th>Router Id</th><th>Status</th><th>ABR</th><th>ASBR</th><th>Areas</th><th>Ports</th><th>Neighbours</th></tr></thead>');
  ...
  echo('<thead><tr><th></th><th>Area Id</th><th>Status</th><th>Ports</th></tr></thead>');
