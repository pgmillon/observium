...
if ($device['type'] == 'wireless' && $device['os'] == 'trapeze')
{
  ...
  foreach ($radios as $radio)
  {
    ...
    if (file_exists($rrdfile))
    {
      $iid = $id;
      echo('<tr><td>');
      echo('<h4> Radio'. $radio['radio_number'] .' - User sessions</h4>');
      ...
      echo('<tr><td>');
      echo('<h4> Radio'. $radio['radio_number'] .' - Retransmit octets</h4>');
      ...
      echo('<tr><td>');
      echo('<h4> Radio'. $radio['radio_number'] .' - Noise Floor</h4>');
      ...
      echo('<tr><td>');
      echo('<h4> Radio'. $radio['radio_number'] .' - Reset</h4>');
      ...
      echo('<tr><td>');
      echo('<h4> Radio'. $radio['radio_number'] .' - Transmit retries</h4>');
      ...
      echo('<tr><td>');
      echo('<h4> Radio'. $radio['radio_number'] .' - Failed client associations</h4>');
      ...
      echo('<tr><td>');
      echo('<h4> Radio'. $radio['radio_number'] .' - Refused connections</h4>');
